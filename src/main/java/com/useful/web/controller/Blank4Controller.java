 ...
 */
@Controller
public class Blank4Controller {
	private static final Logger logger = LoggerFactory.getLogger(Blank4Controller.class);
	
	@RequestMapping(value = "/blank4", method = RequestMethod.GET)
	public String page(Locale locale, Model model) {
		logger.info("blank4", locale);
		return "blank/blank4";
	}
